...
fn root_help_text() -> String {
    let mut lines = [
        ...
        "  codebuff daily             Show Codebuff usage grouped by date",
        "  codebuff monthly           Show Codebuff usage grouped by month",
        "  codebuff session           Show Codebuff usage grouped by session",
        ...
        "  ccusage codebuff daily --help",
        "  ccusage codebuff monthly --help",
        "  ccusage codebuff session --help",
