...
fn agent_report_supported(agent: &str, report: &str) -> bool {
    match agent {
        ...
        "amp" | "droid" | "hermes" | "pi" | "goose" | "kilo" | "copilot" | "gemini" => {
...
fn root_help_text() -> String {
    let mut lines = [
        ...
        "  droid daily                Show Droid usage grouped by date",
        "  droid monthly              Show Droid usage grouped by month",
        "  droid session              Show Droid usage grouped by session",
        ...
        "  ccusage droid daily --help",
        "  ccusage droid monthly --help",
        "  ccusage droid session --help",
