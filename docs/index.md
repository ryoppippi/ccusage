...
hero:
  ...
  tagline: A fast local CLI for tracking tokens and estimated costs across Claude Code, Codex, OpenCode, Amp, pi-agent, and OpenClaw
  image:
    src: /logo.svg
    alt: ccusage logo
  actions:
...
features:
  ...
  - icon: 📁
    ...
    details: Reads local usage logs from Claude Code, Codex, OpenCode, Amp, pi-agent, and OpenClaw without uploading your data
    link: /guide/
  - icon: 💰
    title: Cost Analysis
