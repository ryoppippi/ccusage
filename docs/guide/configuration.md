...
export QWEN_DATA_DIR="$HOME/.qwen"
...
export QWEN_DATA_DIR="$HOME/.qwen,/archive/qwen"
```
...
Configure Claude Code, Codex, OpenCode, Amp, pi-agent, Qwen, GitHub Copilot CLI, and Gemini CLI separately with data source namespaces:
