...
export HERMES_HOME="$HOME/.hermes,/archive/hermes"
...
Configure Claude Code, Codex, OpenCode, Amp, Hermes Agent, pi-agent, GitHub Copilot CLI, and Gemini CLI separately with data source namespaces:
