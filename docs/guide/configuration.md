...
export KILO_DATA_DIR="$HOME/.local/share/kilo,/archive/kilo"
```
...
Configure Claude Code, Codex, OpenCode, Amp, pi-agent, GitHub Copilot CLI, and Kilo separately with data source namespaces:
