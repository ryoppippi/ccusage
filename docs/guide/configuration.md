...
Configure Claude Code, Codex, OpenCode, Amp, Hermes Agent, pi-agent, Goose, OpenClaw, Kilo, Kimi, GitHub Copilot CLI, and Gemini CLI separately with data source namespaces:
