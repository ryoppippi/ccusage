...
Configure Claude Code, Codex, OpenCode, Amp, Hermes Agent, pi-agent, Goose, Kilo, Kimi, Qwen, GitHub Copilot CLI, and Gemini CLI separately with data source namespaces:
