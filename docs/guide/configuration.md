...
export GOOSE_PATH_ROOT="$HOME/.local/share/goose"
...
Configure Claude Code, Codex, OpenCode, Amp, pi-agent, Goose, GitHub Copilot CLI, and Gemini CLI separately with data source namespaces:
