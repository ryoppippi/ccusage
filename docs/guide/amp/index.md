...
If a model is not in the embedded LiteLLM pricing data, the cost will be $0.00. [Open an issue](https://github.com/ryoppippi/ccusage/issues/new) to request alias support.
:::
