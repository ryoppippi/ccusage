...
**ccusage** is a local CLI for understanding coding (agent) CLI token usage and estimated costs across Claude Code, Codex, OpenCode, Amp, pi-agent, and Droid.
...
- **All Sources by Default** - Claude Code, Codex, OpenCode, Amp, pi-agent, and Droid in one CLI
