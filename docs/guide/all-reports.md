...
ccusage detects local usage files from Claude Code, Codex, OpenCode, Amp, pi-agent, GitHub Copilot CLI, and Kimi. The same daily, weekly, monthly, and session views can run in two modes:
