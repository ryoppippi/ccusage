...
ccusage detects local usage files from Claude Code, Codex, OpenCode, Amp, pi-agent, and OpenClaw. The same daily, weekly, monthly, and session views can run in two modes:
