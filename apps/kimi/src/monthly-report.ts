	...
	describe('buildMonthlyReport', () => {
		it('aggregates events by month and calculates costs', async () => {
			const pricing = new Map([
				[
					'kimi-k2.5',
					{ inputCostPerMToken: 0.6, cachedInputCostPerMToken: 0.1, outputCostPerMToken: 3 },
				],
				[
					'kimi-for-coding',
					{ inputCostPerMToken: 0.6, cachedInputCostPerMToken: 0.1, outputCostPerMToken: 3 },
			...
			// kimi-k2.5: 800 non-cached input @ 0.6, 200 cached @ 0.1, 500 output @ 3
			// kimi-for-coding: 300 non-cached input @ 0.6, 100 cached @ 0.1, 200 output @ 3
			const expectedCost =
				(800 / 1_000_000) * 0.6 +
				(200 / 1_000_000) * 0.1 +
				(500 / 1_000_000) * 3 +
