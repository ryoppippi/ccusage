...
> Analyze [pi-agent](https://github.com/badlogic/pi-mono) session usage with the same reporting experience as `ccusage`.

> ⚠️ **Compatibility wrapper:** Prefer `bunx ccusage@latest pi`. This package now prints a deprecation warning and forwards to `ccusage pi`.
