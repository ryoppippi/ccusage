...
This is the published `ccusage` npm package. The CLI implementation lives in Rust under `crates/ccusage`; this package provides the npm metadata, package runner launcher, schema artifact, and benchmark scripts.
...
- Rust CLI implementation: `../../crates/ccusage`
