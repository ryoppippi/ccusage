...
Check out [better-ccusage: The Enhanced Claude Code cost scorecard with multi-provider support]

<p align="center">
    <a href="https://www.youtube.com/watch?v=Ak6qpQ5qdgk">
        <img src="https://cdn.jsdelivr.net/gh/cobra91/ccusage@main/docs/public/ccusage_thumbnail.png" alt="better-ccusage: The Enhanced Claude Code cost scorecard with multi-provider support" width="600">
    </a>
</p>
