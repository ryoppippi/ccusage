...
The main CLI tool for analyzing Claude Code, Codex, OpenCode, Amp, Codebuff, Hermes Agent, pi-agent, Goose, Kilo, GitHub Copilot CLI, and Gemini CLI usage from local data. Track daily, weekly, monthly, and session-based usage with beautiful tables.
...
- 🤖 **Unified CLI Reports**: View Claude Code, Codex, OpenCode, Amp, Codebuff, Hermes Agent, pi-agent, Goose, Kilo, GitHub Copilot CLI, and Gemini CLI usage from one CLI
