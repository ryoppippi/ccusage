...
The main CLI tool for analyzing Claude Code, Codex, OpenCode, Amp, Droid, pi-agent, GitHub Copilot CLI, and Gemini CLI usage from local data. Track daily, weekly, monthly, and session-based usage with beautiful tables.
...
- 🤖 **Unified CLI Reports**: View Claude Code, Codex, OpenCode, Amp, Droid, pi-agent, GitHub Copilot CLI, and Gemini CLI usage from one CLI
