...
| CodeBuddy          | `ccusage codebuddy daily` |
...
- 🤖 **Unified CLI Reports**: View Claude Code, Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, OpenClaw, CodeBuddy, Kilo, Kimi, Qwen, GitHub Copilot CLI, and Gemini CLI usage from one CLI
