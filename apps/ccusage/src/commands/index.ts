...
import { dailyCommand as ampDailyCommand } from '../agents/amp/commands/daily.ts';
import { monthlyCommand as ampMonthlyCommand } from '../agents/amp/commands/monthly.ts';
import { sessionCommand as ampSessionCommand } from '../agents/amp/commands/session.ts';
import { dailyCommand as codexDailyCommand } from '../agents/codex/commands/daily.ts';
import { monthlyCommand as codexMonthlyCommand } from '../agents/codex/commands/monthly.ts';
import { sessionCommand as codexSessionCommand } from '../agents/codex/commands/session.ts';
import { dailyCommand as opencodeDailyCommand } from '../agents/opencode/commands/daily.ts';
import { monthlyCommand as opencodeMonthlyCommand } from '../agents/opencode/commands/monthly.ts';
import { sessionCommand as opencodeSessionCommand } from '../agents/opencode/commands/session.ts';
import { weeklyCommand as opencodeWeeklyCommand } from '../agents/opencode/commands/weekly.ts';
import { dailyCommand as piDailyCommand } from '../agents/pi/commands/daily.ts';
import { monthlyCommand as piMonthlyCommand } from '../agents/pi/commands/monthly.ts';
import { sessionCommand as piSessionCommand } from '../agents/pi/commands/session.ts';
